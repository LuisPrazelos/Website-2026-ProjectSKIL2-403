<x-layouts.app :title="__('Recept bekijken')">
        ...
        <div class="relative h-full flex-1 overflow-hidden rounded-xl border border-neutral-200 dark:border-neutral-700 p-6 bg-transparent">
            ...
            <div class="flex items-center justify-between mb-6">
                ...
                <div class="flex space-x-2">
                    ...
                    <a href="{{ route('owner.recipes.edit', $recipe->id) }}" class="inline-flex items-center px-4 py-2 border rounded-md text-sm bg-black text-white">{{ __('Recept bewerken') }}</a>
                </div>
            </div>
