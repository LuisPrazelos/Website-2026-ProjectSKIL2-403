                    ...
                    <form wire:submit.prevent="store">
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="number" wire:model.defer="portion_size" id="portion_size" step="1" onkeypress="return event.charCode >= 48 && event.charCode <= 57" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                            ...
                            <div>
                                ...
                                <select wire:model.defer="recipe_id" id="recipe_id" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                            ...
                            <div>
                                ...
                                <input type="file" wire:model="photo" id="photo" class="mt-1 block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100">
                                @if ($photo)
                            ...
                            <div>
                                ...
                                <select wire:model.defer="picture_id" id="picture_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                ...
                <div class="bg-white dark:bg-zinc-800 p-8 rounded-lg shadow-lg w-full max-w-lg overflow-y-auto max-h-[90vh]">
                    ...
                    <form wire:submit.prevent="update">
                        <div class="space-y-4">
                            ...
                            <!-- Price Input with Warning Logic -->
                            <div x-data="{ currentPrice: @entangle('price'), originalPrice: @entangle('originalPrice') }">
                                ...
                                <input type="number" x-model="currentPrice" id="edit_price" step="0.01" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                @error('price') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                            ...
                            <div>
                                ...
                                <input type="number" wire:model.defer="portion_size" id="edit_portion_size" step="1" onkeypress="return event.charCode >= 48 && event.charCode <= 57" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                @error('portion_size') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <select wire:model.defer="recipe_id" id="edit_recipe_id" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                    <option value="">Kies een recept</option>
                                    @foreach($recipes as $recipe)
                                        <option value="{{ $recipe->id }}">{{ $recipe->name }}</option>
                                    @endforeach
                            ...
                            <div>
                                ...
                                <input type="file" wire:model="photo" id="edit_photo" class="mt-1 block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100">
                                @if ($photo)
                                    <img src="{{ $photo->temporaryUrl() }}" class="mt-2 w-20 h-20 object-cover rounded-md">
                                @endif
                                @error('photo') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                            ...
                            <div>
                                ...
                                <select wire:model.defer="picture_id" id="edit_picture_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                    <option value="">Geen afbeelding</option>
                                    @foreach($pictures as $picture)
                                        <option value="{{ $picture->id }}">{{ $picture->title }}</option>
                                    @endforeach
